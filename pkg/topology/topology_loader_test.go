...
var expected []string = []string{
	...
	"parse [../../conf/parse-test.topo/13] line[foo, container-3, 1010.0, 911.0, 512.0, 613.000000, 614.000000, 215.000000, 116.1, 17.1, 500, 30] failed: invalid EntityType[foo]",
	"parse [../../conf/parse-test.topo/15] line[container, container-2c, 1010.0, 91z.0, 512.0, 613.000000, 614.000000, 215.000000, 116.0, 17.0] failed: invalid float value '91z.0' at field 4",
	"parse [../../conf/parse-test.topo/17] line[pod, bad-pod] failed: missing container list in pod declaration",
	"parse [../../conf/parse-test.topo/19] line[container, container-1b, 1001.0, 992.0, 503.0, 1624.000000, 225.000000, 256.000000, 107.0, 18.0, 500] failed: input line 'container, container-1b, 1001.0, 992.0, 503.0, 1624.000000, 225.000000, 256.000000, 107.0, 18.0, 500' has insufficient fields",
	"Pod[pod-1] already exists",
	"parse [../../conf/parse-test.topo/22] line[pod, pod-1, container-1] failed: Pod[pod-1] already exists",
	"",
}
